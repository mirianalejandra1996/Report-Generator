...
export default {
  ...
  methods: {
    ...
    // };
      ...
      // const currentValue = shallowRef(moment());
      // const calendar = ref([]);
      // const currentValue = ref(moment());
...
// -----------------
      ...
      //  const endDay = unref(currentValue).clone().endOf("month").endOf("week");
